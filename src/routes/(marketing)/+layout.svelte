...
<div class="navbar bg-base-100 container mx-auto">
  <div class="flex-1">
    <a
      class="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-linear-to-r from-primary to-secondary pb-2"
      href="/">{WebsiteName}</a
    >
  </div>
  <div class="flex-none">
    <ul class="menu menu-horizontal px-1 hidden sm:flex font-bold text-lg">
      <li class="md:mx-2 rounded-l-lg bg-fuchsia-500 hover:bg-white">
        <a href="/for_creators">For Creators</a>
      </li>
      <li class="md:mx-2"><a href="/pricing">Start</a></li>
      <li class="md:mx-2">
...
<div class="">
  ...
  >
    <nav>
      ...
      <a class="link link-hover my-1" href="/contact_us">Contact Us Test</a>
    </nav>
    <aside>
