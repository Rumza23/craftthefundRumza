...
<div class="min-h-[60vh]">
  <div class="pt-20 pb-8 px-7">
    <div class="max-w-lg mx-auto text-center">
      ...
      >
        <!-- Mai cautam variante de titlu. Nu imi plake astea-->
        See the craftventures. Fund what you like.
      </div>
    </div>
    <div
      class="flex gap-6 mt-12 max-w-[1564px] mx-auto place-content-center flex-wrap"
    >
      <div class="stats shadow">
        <div class="stat">
          ...
          <div class="stat-title">Founding</div>
          <div class="stat-value text-primary">25.6K</div>
          <div class="stat-desc">3k Lei today</div>
        </div>
        ...
        <div class="stat">
          ...
          <div class="stat-desc">2k today</div>
        </div>
        ...
        <div class="stat">
          ...
          <div class="stat-title">Founded so far</div>
          <div class="stat-desc text-secondary">4.5k Lei Remaining</div>
        </div>
      </div>
      <ul
      ...
      >
        <li>
          ...
          <div class="timeline-start mb-10 md:text-end">
            ...
            desktop publishing as a general office function. The motherboard, a 9
            in (23 cm) CRT monitor, and a floppy drive were housed in a beige case
            with integrated carrying handle; it came with a keyboard and single-button
            mouse.
          </div>
          <hr />
        </li>
        ...
        <li>
          ...
          <div class="timeline-start mb-10 md:text-end">
            ...
            mobile devices designed and marketed by Apple Inc. The first version
            was released on October 23, 2001, about 8+1⁄2 months after the Macintosh
            version of iTunes was released. Apple sold an estimated 450 million iPod
            products as of 2022. Apple discontinued the iPod product line on May
            10, 2022. At over 20 years, the iPod brand is the oldest to be discontinued
            by Apple
          </div>
          <hr />
        </li>
...
<div class="hero min-h-[60vh] mt-12">
  <div class="hero-content text-center pb-16 pt-4 px-4"></div>
</div>
-->
